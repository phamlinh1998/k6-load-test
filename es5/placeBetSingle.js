...
exports.default = function () {
    (0, _k.group)("Place Bet Single", function () {
        placeBetSingle();
    });
...
var durationTrend = exports.durationTrend = new _metrics.Trend('PlaceBetSingle Duration');
var failRate = exports.failRate = new _metrics.Rate('PlaceBetSingle Fail Rate');
var requestCount = exports.requestCount = new _metrics.Counter('PlaceBetSingle Requests');
...
// var highlights = new _data.SharedArray('highlight_data', function () {
//     return JSON.parse(open('../data/highlight_data.json')).highlights;
// });
...
// var highlights = new _data.SharedArray('highlight_data', function () {
//     const res = _http2.default.get('https://' + __ENV.BASE_URL + '/v1/_me/fixtures/highLight', {
//         headers: {
//             'Content-Type': 'application/json' ,
//             'Authorization': 'Bearer ' + 'eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiIxMDAwIiwiZXhwIjoxNjk3Mjc3ODg2LCJ1c2VySWQiOiIxMDAwIiwiZnVsbE5hbWUiOiJ0ZXN0XzEwMDAiLCJhdmF0YXJVcmwiOiJ0ZXN0XzEwMDAifQ.WOmmK4a9DsBQHwhGUXt7d2Vy2mZCW_1lGLKwe-idMfGC3ePJzyQeeohai6r6qpfKGwZDa9TDCpSNQkJOSGVCz2-wiTMSkHL8Vcsj4LODT_DjOfzpzXXgFNCxSIn0g60_OIRYvpdEFx6pxUGWX2y_Zkc1qEZGMYMTYUL0q0I5eUQ'
//         }
//     });
//     return JSON.parse(res.body);
// });

var placeBetSingle = function placeBetSingle() {
